...
public class UnityBuild
{
	...
	private static readonly Dictionary<BuildTarget, PlatformSpecificBuildOptions> PlatformBuildOptions = new Dictionary<BuildTarget, PlatformSpecificBuildOptions>()
	{
		...
		{ BuildTarget.StandaloneLinux64,   new PlatformSpecificBuildOptions(BuildOptions.Development | BuildOptions.CompressWithLz4,                                 BuildOptions.CompressWithLz4HC) },
	 ...
	 */
	private static readonly string DriveTempDirectory = "C:/Users/kodyb/Documents";
	private static readonly string DriveTempFolderName = "JenkinsTemp";

	private static readonly string DriveDirectory = "C:/Users/kodyb/OneDrive/Projects/Unity Builds";
